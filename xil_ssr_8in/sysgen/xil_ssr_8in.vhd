-- Generated from Simulink block xil_ssr_8in/Scalar2Vector
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_scalar2vector is
  port (
...
end xil_ssr_8in_scalar2vector;
architecture structural of xil_ssr_8in_scalar2vector is 
...
begin
  ...
  o_8 <= slice7_y_net;
  concat_y_net <= i;
  slice0 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 144,
  ...
  slice1 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 18,
    new_msb => 35,
    x_width => 144,
  ...
  slice2 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 36,
    new_msb => 53,
    x_width => 144,
  ...
  slice3 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 54,
    new_msb => 71,
    x_width => 144,
  ...
  slice4 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 72,
    new_msb => 89,
    x_width => 144,
  ...
  slice5 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 90,
    new_msb => 107,
    x_width => 144,
  ...
  slice6 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 108,
    new_msb => 125,
    x_width => 144,
  ...
  slice7 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 126,
    new_msb => 143,
    x_width => 144,
...
-- Generated from Simulink block xil_ssr_8in/Vector Constant
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_vector_constant is
  port (
...
end xil_ssr_8in_vector_constant;
architecture structural of xil_ssr_8in_vector_constant is 
...
begin
  ...
  constant0 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant3 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant4 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant5 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant6 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant7 : entity xil_defaultlib.sysgen_constant_0ec44b0c3d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block xil_ssr_8in/Vector FFT
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_vector_fft is
  port (
...
end xil_ssr_8in_vector_fft;
architecture structural of xil_ssr_8in_vector_fft is 
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay1 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret8 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret9 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret10 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret11 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret12 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret13 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret14 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret15 : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat0 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat2 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat3 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat4 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat5 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat6 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat7 : entity xil_defaultlib.sysgen_concat_300f4b97fa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay2 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay4 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay5 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay6 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay7 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay8 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  delay9 : entity xil_defaultlib.xil_ssr_8in_xldelay 
  generic map (
    latency => 4,
    reg_retiming => 0,
    reset => 0,
  ...
  concat8 : entity xil_defaultlib.sysgen_concat_73675f13eb 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice8 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice9 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice10 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice11 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice12 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice13 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice14 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  slice15 : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 17,
    x_width => 36,
  ...
  reinterpret16 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret17 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret18 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret19 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret20 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret21 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret22 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret23 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block xil_ssr_8in/Vector Reinterpret
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_vector_reinterpret is
  port (
...
end xil_ssr_8in_vector_reinterpret;
architecture structural of xil_ssr_8in_vector_reinterpret is 
  signal reinterpret2_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret6_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal slice1_y_net : std_logic_vector( 18-1 downto 0 );
  signal slice2_y_net : std_logic_vector( 18-1 downto 0 );
...
begin
  ...
  slice6_y_net <= in_7;
  slice7_y_net <= in_8;
  reinterpret0 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret5 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret6 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret7 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block xil_ssr_8in/Vector Reinterpret1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_vector_reinterpret1 is
  port (
    in_1 : in std_logic_vector( 18-1 downto 0 );
    in_2 : in std_logic_vector( 18-1 downto 0 );
    in_3 : in std_logic_vector( 18-1 downto 0 );
...
end xil_ssr_8in_vector_reinterpret1;
architecture structural of xil_ssr_8in_vector_reinterpret1 is 
  signal reinterpret0_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret19_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret4_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret16_output_port_net : std_logic_vector( 18-1 downto 0 );
...
-- Generated from Simulink block xil_ssr_8in/Vector2Scalar
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_vector2scalar is
  port (
...
end xil_ssr_8in_vector2scalar;
architecture structural of xil_ssr_8in_vector2scalar is 
  signal reinterpret2_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret0_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret1_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret7_output_port_net : std_logic_vector( 18-1 downto 0 );
...
begin
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_89a4597b4f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block xil_ssr_8in_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_struct is
  port (
...
end xil_ssr_8in_struct;
architecture structural of xil_ssr_8in_struct is 
  signal reinterpret6_output_port_net_x0 : std_logic_vector( 18-1 downto 0 );
  signal reinterpret9_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret13_output_port_net : std_logic_vector( 18-1 downto 0 );
  signal reinterpret10_output_port_net : std_logic_vector( 18-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  scalar2vector : entity xil_defaultlib.xil_ssr_8in_scalar2vector 
  port map (
    i => concat_y_net,
    o_1 => slice0_y_net,
    o_2 => slice1_y_net,
  ...
  vector_constant : entity xil_defaultlib.xil_ssr_8in_vector_constant 
  port map (
    out1_1 => constant0_op_net,
  ...
  vector_fft : entity xil_defaultlib.xil_ssr_8in_vector_fft 
  port map (
  ...
  vector_reinterpret : entity xil_defaultlib.xil_ssr_8in_vector_reinterpret 
  port map (
    in_1 => slice0_y_net,
    in_2 => slice1_y_net,
    in_3 => slice2_y_net,
  ...
  vector_reinterpret1 : entity xil_defaultlib.xil_ssr_8in_vector_reinterpret1 
  port map (
  ...
  vector2scalar : entity xil_defaultlib.xil_ssr_8in_vector2scalar 
  port map (
  ...
  concat : entity xil_defaultlib.sysgen_concat_89a4597b4f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_dd800436d9 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_bf61a44c26 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret : entity xil_defaultlib.sysgen_reinterpret_7e0a60cdb2 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret10 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret11 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret12 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret13 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret14 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret15 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret8 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret9 : entity xil_defaultlib.sysgen_reinterpret_178f13cae3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice : entity xil_defaultlib.xil_ssr_8in_xlslice 
  generic map (
    new_lsb => 126,
    new_msb => 143,
    x_width => 144,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity xil_ssr_8in_default_clock_driver is
  port (
    xil_ssr_8in_sysclk : in std_logic;
    xil_ssr_8in_sysce : in std_logic;
    xil_ssr_8in_sysclr : in std_logic;
    xil_ssr_8in_clk1 : out std_logic;
    xil_ssr_8in_ce1 : out std_logic
  );
end xil_ssr_8in_default_clock_driver;
architecture structural of xil_ssr_8in_default_clock_driver is 
begin
  ...
  port map (
    sysclk => xil_ssr_8in_sysclk,
    sysce => xil_ssr_8in_sysce,
    sysclr => xil_ssr_8in_sysclr,
    clk => xil_ssr_8in_clk1,
    ce => xil_ssr_8in_ce1
  );
end structural;
-- Generated from Simulink block 
...
architecture structural of xil_ssr_8in is 
  attribute core_generation_info : string;
  attribute core_generation_info of structural : architecture is "xil_ssr_8in,sysgen_core_2021_1,{,compilation=IP Catalog,block_icon_display=Default,family=virtexuplusHBM,part=xcvu37p,speed=-2L-e,package=fsvh2892,synthesis_language=vhdl,hdl_library=xil_defaultlib,synthesis_strategy=Vivado Synthesis Defaults,implementation_strategy=Vivado Implementation Defaults,testbench=0,interface_doc=0,ce_clr=0,clock_period=10,system_simulink_period=1,waveform_viewer=0,axilite_interface=0,ip_catalog_plugin=0,hwcosim_burst_mode=0,simulation_time=2048,blackbox2=1,concat=11,constant=10,delay=10,reinterpret=64,slice=40,}";
  signal ce_1_net : std_logic;
  signal clk_1_net : std_logic;
begin
  xil_ssr_8in_default_clock_driver : entity xil_defaultlib.xil_ssr_8in_default_clock_driver 
  port map (
    xil_ssr_8in_sysclk => clk,
    xil_ssr_8in_sysce => '1',
    xil_ssr_8in_sysclr => '0',
    xil_ssr_8in_clk1 => clk_1_net,
    xil_ssr_8in_ce1 => ce_1_net
  );
  xil_ssr_8in_struct : entity xil_defaultlib.xil_ssr_8in_struct 
  port map (
    in0 => in0,
    in1 => in1,
    in2 => in2,
