...
end xilinx_ssr_8in_stub;
architecture structural of xilinx_ssr_8in_stub is 
begin
  sysgen_dut : entity xil_defaultlib.xilinx_ssr_8in_0 
  port map (
    in0 => in0,
    in1 => in1,
    in2 => in2,
